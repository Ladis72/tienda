...
"}"));
        ...
        lbSalidas->setObjectName(QString::fromUtf8("lbSalidas"));
        QFont font1;
        ...
        horizontalLayoutDest->setObjectName(QString::fromUtf8("horizontalLayoutDest"));
        ...
        horizontalSpacerDest = new QSpacerItem(0, 0, QSizePolicy::Expanding, QSizePolicy::Minimum);
