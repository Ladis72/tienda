...
public:
    ...
    void setupUi(QDialog *BuscarProducto)
    {
        ...
        checkBox_conStock->setObjectName(QString::fromUtf8("checkBox_conStock"));
        ...
        frame_detalles->setObjectName(QString::fromUtf8("frame_detalles"));
        ...
        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Policy::Expanding);
