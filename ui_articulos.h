...
public:
    ...
    QPushButton *pushButtonCambiarCodigo;
    QLabel *label_2;
    QLabel *label_4;
    ...
    QPushButton *pushButtonBuscarFabricante;
    ...
    QRadioButton *radioButtonProveedores;
    ...
    QPushButton *pushButtonAnadirAPedido;
    ...
    void setupUi(QDialog *Articulos)
    {
        ...
        Articulos->resize(1209, 629);
        Articulos->setStyleSheet(QString::fromUtf8("QDialog { background-color: #f8f9fa; }"));
        verticalLayout = new QVBoxLayout(Articulos);
        verticalLayout->setSpacing(15);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        verticalLayout->setContentsMargins(20, 20, 20, 20);
        headerFrame = new QFrame(Articulos);
...
"}"));
        ...
        labelIcono->setPixmap(QPixmap(QString::fromUtf8("../iconos/articulos.png")));
        labelIcono->setScaledContents(true);

        horizontalLayoutHeader->addWidget(labelIcono);

        labelNombreProducto = new QLabel(headerFrame);
        labelNombreProducto->setObjectName(QString::fromUtf8("labelNombreProducto"));
        QFont font;
        font.setPointSize(18);
        font.setBold(true);
        labelNombreProducto->setFont(font);
        labelNombreProducto->setStyleSheet(QString::fromUtf8("color: #e65100;"));

        horizontalLayoutHeader->addWidget(labelNombreProducto);
        ...
        labelPrecioGrande = new QLabel(headerFrame);
        labelPrecioGrande->setObjectName(QString::fromUtf8("labelPrecioGrande"));
        QFont font1;
        font1.setPointSize(24);
        font1.setBold(true);
        labelPrecioGrande->setFont(font1);
        labelPrecioGrande->setStyleSheet(QString::fromUtf8("color: #bf360c;"));
        labelPrecioGrande->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);

        horizontalLayoutHeader->addWidget(labelPrecioGrande);
        ...
        pushButtonCambiarCodigo = new QPushButton(General);
        pushButtonCambiarCodigo->setObjectName(QString::fromUtf8("pushButtonCambiarCodigo"));
        pushButtonCambiarCodigo->setEnabled(false);
        pushButtonCambiarCodigo->setAutoDefault(false);

        gridLayout->addWidget(pushButtonCambiarCodigo, 0, 3, 1, 1);
        ...
        pushButtonBuscarFabricante = new QPushButton(General);
        pushButtonBuscarFabricante->setObjectName(QString::fromUtf8("pushButtonBuscarFabricante"));
        pushButtonBuscarFabricante->setMaximumSize(QSize(40, 16777215));
        pushButtonBuscarFabricante->setAutoDefault(false);

        gridLayout->addWidget(pushButtonBuscarFabricante, 7, 3, 1, 1);
        ...
        treeWidgetStockTiendas->setMinimumSize(QSize(400, 0));
        treeWidgetStockTiendas->setAlternatingRowColors(true);
        treeWidgetStockTiendas->setSortingEnabled(true);
        ...
        layOutVentas->setObjectName(QString::fromUtf8("layOutVentas"));
        widgetVentas = new QWidget(tabVentas);
        widgetVentas->setObjectName(QString::fromUtf8("widgetVentas"));
        ...
        radioButtonProveedores = new QRadioButton(groupBox_2);
        radioButtonProveedores->setObjectName(QString::fromUtf8("radioButtonProveedores"));

        horizontalLayout_3->addWidget(radioButtonProveedores);
        ...
        pushButtonAnadirAPedido = new QPushButton(Articulos);
        pushButtonAnadirAPedido->setObjectName(QString::fromUtf8("pushButtonAnadirAPedido"));
        pushButtonAnadirAPedido->setAutoDefault(false);

        horizontalLayout->addWidget(pushButtonAnadirAPedido);
        ...
        QWidget::setTabOrder(lineEditCodFabricante, pushButtonBuscarFabricante);
        QWidget::setTabOrder(pushButtonBuscarFabricante, comboBoxFormato);
    ...
    void retranslateUi(QDialog *Articulos)
    {
        ...
        labelNombreProducto->setText(QCoreApplication::translate("Articulos", "Detalles del Producto", nullptr));
        labelPrecioGrande->setText(QCoreApplication::translate("Articulos", "0.00 \342\202\254", nullptr));
        ...
        pushButtonCambiarCodigo->setText(QCoreApplication::translate("Articulos", "Cambiar c\303\263digo", nullptr));
        ...
        pushButtonBuscarFabricante->setText(QString());
        pushButtonBuscarFamilia->setText(QString());
        ...
        radioButtonProveedores->setText(QCoreApplication::translate("Articulos", "Proveedores", nullptr));
        ...
        pushButtonAnadirAPedido->setText(QCoreApplication::translate("Articulos", "A\303\261adir a Pedido", nullptr));
