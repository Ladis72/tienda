...
public:
    ...
    void setupUi(QDialog *ListadoSalidas)
    {
        ...
        label_tipo = new QLabel(ListadoSalidas);
        ...
        comboBoxTipo = new QComboBox(ListadoSalidas);
        comboBoxTipo->setObjectName(QString::fromUtf8("comboBoxTipo"));
        QSizePolicy sizePolicy(QSizePolicy::Expanding, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(comboBoxTipo->sizePolicy().hasHeightForWidth());
        comboBoxTipo->setSizePolicy(sizePolicy);

        horizontalLayout->addWidget(comboBoxTipo);
    ...
    void retranslateUi(QDialog *ListadoSalidas)
    {
        ...
        label_tipo->setText(QCoreApplication::translate("ListadoSalidas", "Tipo", nullptr));
