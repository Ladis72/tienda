...
imprimirPedido::imprimirPedido(QString tienda, QStringList cabecera, QSqlQueryModel *modelo)
{
    ...
    QString html = "<!DOCTYPE html>\n"
                   ...
                   "<BODY>\n"
                   "<div class='container'>\n"
                   "<h3 class='text-center' style='text-align: center'>PEDIDO Nº:"
                   + cabecera.at(0) + " de " + cabecera.at(1)
                   + "</h3>\n\n\n"
    ...
    pagina << "<thead>"
              ...
              "th><th>COSTO</th><th>DESCUENTO</th><th>I.V.A.</th><th>P.V.P.</th></tr>"
              "</thead";
    //Datos tabla
    pagina << "<tbody>";
