...
private slots:
    ...
    // --- Slots conectados al motor AsistenteIA ---
    void slotRespuestaRecibida(const QString &respuesta);
...
private:
    ...
    void agregarBurbuja(const QString &remitente, const QString &texto, const QString &colorFondo, const QString &colorBorde, bool esUsuario);
