...
template <> constexpr inline auto EntradaMercancia::qt_create_metaobjectdata<qt_meta_tag_ZN16EntradaMercanciaE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(const QSqlRecord &)>(9, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 10, 11 },
        }}),
        ...
        // Slot 'on_pushButtonSalir_clicked'
...
void EntradaMercancia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->on_dateEditCaducidad_editingFinished(); break;
        case 6: _t->actualizarTotales(); break;
        case 7: _t->procesarLineaEntrada((*reinterpret_cast<std::add_pointer_t<QSqlRecord>>(_a[1]))); break;
        case 8: _t->actualizarArticulo((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[3]))); break;
        case 9: _t->guardarArticulo((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 10: _t->limpiarTabla((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 11: _t->on_comboBoxProcedencia_currentIndexChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 12: _t->on_pushButtonSalir_clicked(); break;
        default: ;
        }
    }
}
