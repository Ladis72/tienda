...
public:
    ...
    void setupUi(QDialog *EditorPermisos)
    {
        if (EditorPermisos->objectName().isEmpty())
            EditorPermisos->setObjectName("EditorPermisos");
...
"}"));
        ...
        layoutRol->setObjectName("layoutRol");
        ...
        layoutPermisos->setObjectName("layoutPermisos");
