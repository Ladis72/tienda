...
public:
    ...
    QPushButton *btn_encargo;
    QPushButton *btnGestorEncargos;
    ...
    void setupUi(QWidget *Tpv)
    {
        ...
        label_vendedor->setObjectName("label_vendedor");
        ...
        btn_modificar->setObjectName("btn_modificar");

        horizontalLayout->addWidget(btn_modificar);

        pushButtonBorrarTodo = new QPushButton(Tpv);
        pushButtonBorrarTodo->setObjectName("pushButtonBorrarTodo");
        ...
        btn_preTicket->setObjectName("btn_preTicket");

        horizontalLayout->addWidget(btn_preTicket);

        btn_encargo = new QPushButton(Tpv);
        btn_encargo->setObjectName("btn_encargo");

        horizontalLayout->addWidget(btn_encargo);

        btnGestorEncargos = new QPushButton(Tpv);
        btnGestorEncargos->setObjectName("btnGestorEncargos");

        horizontalLayout->addWidget(btnGestorEncargos);
        ...
        tableViewTicketsPendientes->setObjectName("tableViewTicketsPendientes");
        ...
        labelAcumulado->setObjectName("labelAcumulado");

        gridLayout_2->addWidget(labelAcumulado, 0, 3, 1, 1);

        lineEdit_cod_cliente = new QLineEdit(groupBox_cliente);
        lineEdit_cod_cliente->setObjectName("lineEdit_cod_cliente");
        ...
        lineEdit_nobre_cliente->setObjectName("lineEdit_nobre_cliente");

        gridLayout_2->addWidget(lineEdit_nobre_cliente, 0, 2, 1, 1);

        labelVale = new QLabel(groupBox_cliente);
        labelVale->setObjectName("labelVale");
        ...
        labelFoto = new ClickableLabel(Tpv);
        ...
        lcdNumber_total->setCursor(QCursor(Qt::CursorShape::ArrowCursor));
        ...
        lineEdit_descuento->setObjectName("lineEdit_descuento");
        ...
        lineEdit_Uds->setObjectName("lineEdit_Uds");
        ...
        lcdProductos->setObjectName("lcdProductos");
        QFont font1;
        font1.setBold(true);
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::LabelRole, label_8);
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, labelStock);
        ...
        retranslateUi(Tpv);
        QObject::connect(btn_cerrar, &QPushButton::clicked, Tpv, qOverload<>(&QWidget::close));
        QObject::connect(lineEdit_Uds, &QLineEdit::returnPressed, lineEdit_cod, qOverload<>(&QLineEdit::setFocus));
        QObject::connect(lineEdit_Uds, &QLineEdit::returnPressed, lineEdit_cod, qOverload<>(&QLineEdit::selectAll));
        QObject::connect(lineEdit_descuento, &QLineEdit::returnPressed, lineEdit_cod, qOverload<>(&QLineEdit::setFocus));
        QObject::connect(lineEdit_descuento, &QLineEdit::returnPressed, lineEdit_cod, qOverload<>(&QLineEdit::selectAll));
        QObject::connect(lineEdit_precio, &QLineEdit::returnPressed, lineEdit_cod, qOverload<>(&QLineEdit::setFocus));
        QObject::connect(lineEdit_precio, &QLineEdit::returnPressed, lineEdit_cod, qOverload<>(&QLineEdit::selectAll));
    ...
    void retranslateUi(QWidget *Tpv)
    {
        ...
        btn_encargo->setText(QCoreApplication::translate("Tpv", "Hacer Encargo", nullptr));
#if QT_CONFIG(tooltip)
        btn_encargo->setToolTip(QCoreApplication::translate("Tpv", "Crear un encargo / reserva (F9)", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        btn_encargo->setShortcut(QCoreApplication::translate("Tpv", "F9", nullptr));
#endif // QT_CONFIG(shortcut)
        btnGestorEncargos->setText(QCoreApplication::translate("Tpv", "Gestor Encargos", nullptr));
#if QT_CONFIG(tooltip)
        btnGestorEncargos->setToolTip(QCoreApplication::translate("Tpv", "Abrir el Gestor de Encargos (F10)", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        btnGestorEncargos->setShortcut(QCoreApplication::translate("Tpv", "F10", nullptr));
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
