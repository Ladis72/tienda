...
public:
    ...
    void setupUi(QDialog *TiposEntradasSalidas)
    {
        if (TiposEntradasSalidas->objectName().isEmpty())
            TiposEntradasSalidas->setObjectName("TiposEntradasSalidas");
        ...
        pushButtonUnificar = new QPushButton(splitter);
        pushButtonUnificar->setObjectName("pushButtonUnificar");
        splitter->addWidget(pushButtonUnificar);
        pushButtonSaneador = new QPushButton(splitter);
        pushButtonSaneador->setObjectName("pushButtonSaneador");
        splitter->addWidget(pushButtonSaneador);
        ...
        QWidget::setTabOrder(pushButton_2, pushButtonUnificar);
        QWidget::setTabOrder(pushButtonUnificar, pushButton_3);
        QWidget::setTabOrder(pushButton_3, tableView);

        retranslateUi(TiposEntradasSalidas);
        QObject::connect(pushButton_3, &QPushButton::clicked, TiposEntradasSalidas, qOverload<>(&QDialog::accept));
    ...
    {
        TiposEntradasSalidas->setWindowTitle(QCoreApplication::translate("TiposEntradasSalidas", "Configuraci\303\263n de Motivos", nullptr));
        ...
        pushButtonUnificar->setText(QCoreApplication::translate("TiposEntradasSalidas", "Unificar y Limpiar", nullptr));
        pushButtonSaneador->setText(QCoreApplication::translate("TiposEntradasSalidas", "Saneador Global", nullptr));
