...
public:
    ...
    void setupUi(QDialog *CopiaSeguridad)
    {
        if (CopiaSeguridad->objectName().isEmpty())
            CopiaSeguridad->setObjectName("CopiaSeguridad");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, CopiaSeguridad, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, CopiaSeguridad, qOverload<>(&QDialog::reject));
