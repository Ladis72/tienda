...
"QLabel { color: #424242; }"));
        ...
        vbox_hu->setObjectName("vbox_hu");
        label_u = new QLabel(headerFrame);
        label_u->setObjectName("label_u");

        vbox_hu->addWidget(label_u);

        labelFUArqueo = new QLabel(headerFrame);
        labelFUArqueo->setObjectName("labelFUArqueo");
        ...
        groupBox_efectivo->setObjectName("groupBox_efectivo");
        gridLayout_conteo = new QGridLayout(groupBox_efectivo);
        gridLayout_conteo->setObjectName("gridLayout_conteo");
        ...
        spinBox500->setObjectName("spinBox500");
        ...
        groupBox_sistema->setObjectName("groupBox_sistema");
        gridLayout_sys = new QGridLayout(groupBox_sistema);
        gridLayout_sys->setObjectName("gridLayout_sys");
        label_ve = new QLabel(groupBox_sistema);
        label_ve->setObjectName("label_ve");

        gridLayout_sys->addWidget(label_ve, 0, 0, 1, 1);

        label_ventasEfectivo = new QLabel(groupBox_sistema);
        label_ventasEfectivo->setObjectName("label_ventasEfectivo");
        ...
        groupBox_manual->setObjectName("groupBox_manual");
        gridLayout_man = new QGridLayout(groupBox_manual);
        gridLayout_man->setObjectName("gridLayout_man");
        label_ma_t = new QLabel(groupBox_manual);
        label_ma_t->setObjectName("label_ma_t");

        gridLayout_man->addWidget(label_ma_t, 0, 0, 1, 1);

        lineEditVentasTarjeta = new QLineEdit(groupBox_manual);
        lineEditVentasTarjeta->setObjectName("lineEditVentasTarjeta");
        ...
        groupBox_resumen->setObjectName("groupBox_resumen");
        gridLayout_res = new QGridLayout(groupBox_resumen);
        gridLayout_res->setObjectName("gridLayout_res");
        label_tv_t = new QLabel(groupBox_resumen);
        label_tv_t->setObjectName("label_tv_t");

        gridLayout_res->addWidget(label_tv_t, 0, 0, 1, 1);

        label_ventasTotales = new QLabel(groupBox_resumen);
        label_ventasTotales->setObjectName("label_ventasTotales");
        ...
        labelDescuadre->setObjectName("labelDescuadre");
        ...
        h_info->setObjectName("h_info");
        label_sa_t = new QLabel(Cajas);
        label_sa_t->setObjectName("label_sa_t");

        h_info->addWidget(label_sa_t);

        labelSaldoAnterior = new QLabel(Cajas);
        labelSaldoAnterior->setObjectName("labelSaldoAnterior");

        h_info->addWidget(labelSaldoAnterior);

        h_s = new QSpacerItem(0, 0, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        h_buttons->setObjectName("h_buttons");
        pushButtonRetirarDinero = new QPushButton(Cajas);
        pushButtonRetirarDinero->setObjectName("pushButtonRetirarDinero");

        h_buttons->addWidget(pushButtonRetirarDinero);

        h_s2 = new QSpacerItem(0, 0, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
