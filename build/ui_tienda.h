...
public:
    ...
    void setupUi(QMainWindow *Tienda)
    {
        ...
        horizontalLayout_VentasButtons->setObjectName("horizontalLayout_VentasButtons");
        ...
        verticalSpacer_Ventas = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        pushButtonArticulos->setObjectName("pushButtonArticulos");

        gridLayout_3->addWidget(pushButtonArticulos, 1, 0, 1, 1);

        pushButtonClientes = new QPushButton(tabFicheros);
        pushButtonClientes->setObjectName("pushButtonClientes");
        ...
        verticalSpacer_tabFicheros = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        pushButtonVentaArticulos->setObjectName("pushButtonVentaArticulos");

        gridLayout_2->addWidget(pushButtonVentaArticulos, 0, 0, 1, 1);

        pushButtonCaducidades = new QPushButton(tabListados);
        pushButtonCaducidades->setObjectName("pushButtonCaducidades");
        ...
        verticalSpacer_tabListados = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        verticalSpacer_TabPedidos = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        verticalSpacer_tabOperaciones = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        gridLayout_4->addItem(verticalSpacer_tabOperaciones, 1, 0, 1, 1);

        tab->addTab(tabOperaciones, QString());
        tabEstadisticas = new QWidget();
        tabEstadisticas->setObjectName("tabEstadisticas");
        ...
        gridLayout_Estadisticas->setObjectName("gridLayout_Estadisticas");
        pushButtonEstadisticas = new QPushButton(tabEstadisticas);
        pushButtonEstadisticas->setObjectName("pushButtonEstadisticas");
        ...
        verticalSpacer_tabEstadisticas = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        pushButtonConfigDB->setObjectName("pushButtonConfigDB");

        gridLayout_6->addWidget(pushButtonConfigDB, 0, 5, 1, 1);

        pushButtonUnificarGlobal = new QPushButton(tabConfig);
        pushButtonUnificarGlobal->setObjectName("pushButtonUnificarGlobal");
        ...
        verticalSpacer_tabConfig = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        verticalSpacer_tabSalir = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
