...
public:
    ...
    void setupUi(QWidget *comprasVentasRemoto)
    {
        if (comprasVentasRemoto->objectName().isEmpty())
            comprasVentasRemoto->setObjectName("comprasVentasRemoto");
        ...
        tabCompras->setObjectName("tabCompras");
        ...
        radioButtonComprasano->setObjectName("radioButtonComprasano");
        ...
        groupBoxVentas->setObjectName("groupBoxVentas");
        ...
        radioButtonVentaMes->setObjectName("radioButtonVentaMes");
        ...
        QObject::connect(pushButton, &QPushButton::clicked, comprasVentasRemoto, qOverload<>(&QWidget::close));
