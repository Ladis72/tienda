...
"}"));
        ...
        verticalLayoutTitleHeader->setObjectName("verticalLayoutTitleHeader");
        labelTitleMain = new QLabel(headerFrame);
        labelTitleMain->setObjectName("labelTitleMain");
        QFont font;
...
"}"));
        ...
        gridLayoutEdit->setObjectName("gridLayoutEdit");
...
"}"));
        ...
        horizontalLayoutFooter->setObjectName("horizontalLayoutFooter");
        ...
        horizontalSpacerFooter = new QSpacerItem(0, 0, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        horizontalLayoutFooter->addItem(horizontalSpacerFooter);

        gridLayoutTotals = new QGridLayout();
        gridLayoutTotals->setObjectName("gridLayoutTotals");
