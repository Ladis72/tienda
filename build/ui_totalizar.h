...
public:
    ...
    QCheckBox *checkBoxNoTicketRegalo;

    void setupUi(QDialog *totalizar)
    {
        if (totalizar->objectName().isEmpty())
            totalizar->setObjectName("totalizar");
        ...
        lineEditEntrega->setObjectName("lineEditEntrega");
        ...
        lineEditCambio->setObjectName("lineEditCambio");
        ...
        lineEditImporte->setObjectName("lineEditImporte");
        ...
        lineEditVale->setObjectName("lineEditVale");
        ...
        pushButtonCobrar->setObjectName("pushButtonCobrar");
        ...
        pushButtonFactura->setObjectName("pushButtonFactura");
        ...
        checkBoxVale->setObjectName("checkBoxVale");

        horizontalLayout_3->addWidget(checkBoxVale);

        checkBoxNoTicketRegalo = new QCheckBox(totalizar);
        checkBoxNoTicketRegalo->setObjectName("checkBoxNoTicketRegalo");

        horizontalLayout_3->addWidget(checkBoxNoTicketRegalo);
        ...
        QObject::connect(pushButtonSalir, &QPushButton::clicked, totalizar, qOverload<>(&QDialog::reject));
        QObject::connect(pushButtonCobrar, &QPushButton::clicked, totalizar, qOverload<>(&QDialog::accept));
    ...
    void retranslateUi(QDialog *totalizar)
    {
        ...
        checkBoxNoTicketRegalo->setText(QCoreApplication::translate("totalizar", "No imprimir ticket regalo", nullptr));
#if QT_CONFIG(shortcut)
        checkBoxNoTicketRegalo->setShortcut(QCoreApplication::translate("totalizar", "F10", nullptr));
#endif // QT_CONFIG(shortcut)
    } // retranslateUi
