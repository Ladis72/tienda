...
public:
    ...
    void setupUi(QDialog *Cajas)
    {
        ...
        doubleSpinBoxCambios->setLocale(QLocale(QLocale::Spanish, QLocale::UnitedStates));
        ...
        QFont font2;
        font2.setFamilies({QString::fromUtf8("Fira Sans")});
        font2.setBold(true);
        ...
        doubleSpinBoxTarjetas->setObjectName("doubleSpinBoxTarjetas");
        doubleSpinBoxTarjetas->setFont(font1);
        doubleSpinBoxTarjetas->setLocale(QLocale(QLocale::Spanish, QLocale::UnitedStates));
        ...
        doubleSpinBoxCajaF->setLocale(QLocale(QLocale::Spanish, QLocale::UnitedStates));
        ...
        QFont font3;
        font3.setFamilies({QString::fromUtf8("Fira Sans")});
        ...
        QFont font4;
        font4.setFamilies({QString::fromUtf8("Fira Sans")});
        ...
        label_ventasTarjeta->setObjectName("label_ventasTarjeta");
        ...
        retranslateUi(Cajas);
        QObject::connect(pushButtonCerrar, &QPushButton::clicked, Cajas, qOverload<>(&QDialog::close));
