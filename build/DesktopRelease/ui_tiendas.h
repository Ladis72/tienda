...
public:
    ...
    void setupUi(QDialog *tiendas)
    {
        ...
        general->addWidget(lineEditPassword, 5, 4, 1, 1);
        ...
        general->addWidget(label_8, 4, 3, 1, 1);

        lineEditUsusario = new QLineEdit(general_2);
        lineEditUsusario->setObjectName("lineEditUsusario");

        general->addWidget(lineEditUsusario, 4, 4, 1, 1);

        label_11 = new QLabel(general_2);
        label_11->setObjectName("label_11");

        general->addWidget(label_11, 3, 3, 1, 1);

        lineEditBase = new QLineEdit(general_2);
        lineEditBase->setObjectName("lineEditBase");

        general->addWidget(lineEditBase, 3, 4, 1, 1);
        ...
        QWidget::setTabOrder(lineEditIP, pushButtonNuevo);
        ...
        QObject::connect(pushButtonCerrar, &QPushButton::clicked, tiendas, qOverload<>(&QDialog::accept));
    ...
    void retranslateUi(QDialog *tiendas)
    {
        ...
        label_11->setText(QCoreApplication::translate("tiendas", "Base de datos", nullptr));
    } // retranslateUi
