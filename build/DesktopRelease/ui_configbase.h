...
public:
    ...
    void setupUi(QDialog *ConfigBase)
    {
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, lineEditDireccion);
        ...
        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, lineEditPuerto);
        ...
        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, lineEditUsuario);
        ...
        formLayout->setWidget(4, QFormLayout::ItemRole::FieldRole, lineEditClave);

        pushButton = new QPushButton(ConfigBase);
        pushButton->setObjectName("pushButton");

        formLayout->setWidget(5, QFormLayout::ItemRole::LabelRole, pushButton);

        pushButton_2 = new QPushButton(ConfigBase);
        pushButton_2->setObjectName("pushButton_2");

        formLayout->setWidget(5, QFormLayout::ItemRole::FieldRole, pushButton_2);
        ...
        formLayout->setWidget(3, QFormLayout::ItemRole::FieldRole, lineEditBaseDatos);
        ...
        QObject::connect(pushButton_2, &QPushButton::clicked, ConfigBase, qOverload<>(&QDialog::reject));
