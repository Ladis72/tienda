...
public:
    ...
    void setupUi(QDialog *Clientes)
    {
        ...
        pushButtonReffrescar->setObjectName("pushButtonReffrescar");
        ...
        radioButtonFechas->setObjectName("radioButtonFechas");
        ...
        pushButtonVerProductos2->setObjectName("pushButtonVerProductos2");

        horizontalLayout_2->addWidget(pushButtonVerProductos2);

        pushButtonVerProductos = new QPushButton(groupBox);
        pushButtonVerProductos->setObjectName("pushButtonVerProductos");
        ...
        QObject::connect(radioButtonFechas, &QRadioButton::toggled, dateEditDesde, &QDateEdit::setEnabled);
        QObject::connect(radioButtonFechas, &QRadioButton::toggled, dateEditHasta, &QDateEdit::setEnabled);
