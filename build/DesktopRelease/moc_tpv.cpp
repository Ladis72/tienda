...
template <> constexpr inline auto Tpv::qt_create_metaobjectdata<qt_meta_tag_ZN3TpvE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'usarVale'
        QtMocHelpers::SlotData<void(int, int, double)>(20, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 21 }, { QMetaType::Int, 22 }, { QMetaType::Double, 23 },
        }}),
        // Slot 'mostrarFoto'
...
void Tpv::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 16: _t->usarVale((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<double>>(_a[3]))); break;
        case 17: _t->mostrarFoto(); break;
        default: ;
        }
    }
