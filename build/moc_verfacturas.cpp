...
namespace {
struct qt_meta_tag_ZN11VerFacturasE_t {};
} // unnamed namespace

template <> constexpr inline auto VerFacturas::qt_create_metaobjectdata<qt_meta_tag_ZN11VerFacturasE_t>()
{
    namespace QMC = QtMocConstants;
    QtMocHelpers::StringRefStorage qt_stringData {
        "VerFacturas",
        "on_checkBoxTodosProveedores_clicked",
        "",
        "checked",
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_checkBoxTodosProveedores_clicked'
    ...
    return QtMocHelpers::metaObjectData<VerFacturas, qt_meta_tag_ZN11VerFacturasE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject VerFacturas::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11VerFacturasE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11VerFacturasE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11VerFacturasE_t>.metaTypes,
    nullptr
} };
...
void VerFacturas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_checkBoxTodosProveedores_clicked((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
...
void *VerFacturas::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11VerFacturasE_t>.strings))
