...
public:
    ...
    void setupUi(QDialog *Formatos)
    {
        if (Formatos->objectName().isEmpty())
            Formatos->setObjectName("Formatos");
        ...
        lineEditFiltro->setObjectName("lineEditFiltro");
        ...
        pushButtonnadir->setObjectName("pushButtonnadir");
        ...
        pushButtonUnificar = new QPushButton(Formatos);
        pushButtonUnificar->setObjectName("pushButtonUnificar");

        gridLayout->addWidget(pushButtonUnificar, 3, 0, 1, 4);

        pushButtonSaneador = new QPushButton(Formatos);
        pushButtonSaneador->setObjectName("pushButtonSaneador");

        gridLayout->addWidget(pushButtonSaneador, 4, 0, 1, 4);


        retranslateUi(Formatos);
        QObject::connect(pushButtonCerrar, &QPushButton::clicked, Formatos, qOverload<>(&QDialog::reject));
    ...
    {
        Formatos->setWindowTitle(QCoreApplication::translate("Formatos", "Formatos", nullptr));
        ...
        pushButtonUnificar->setText(QCoreApplication::translate("Formatos", "Unificar y Limpiar", nullptr));
        pushButtonSaneador->setText(QCoreApplication::translate("Formatos", "Saneador Global", nullptr));
    } // retranslateUi
