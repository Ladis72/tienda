...
public:
    ...
    void setupUi(QDialog *UnificarProveedores)
    {
        if (UnificarProveedores->objectName().isEmpty())
            UnificarProveedores->setObjectName(QString::fromUtf8("UnificarProveedores"));
        ...
        tabSaneamiento->setObjectName(QString::fromUtf8("tabSaneamiento"));
        ...
        pushButtonNormalizarNIF->setObjectName(QString::fromUtf8("pushButtonNormalizarNIF"));
        ...
        pushButtonDetectarNIF->setObjectName(QString::fromUtf8("pushButtonDetectarNIF"));

        verticalLayout_2->addWidget(pushButtonDetectarNIF);

        textEditLogSaneamiento = new QTextEdit(tabSaneamiento);
        textEditLogSaneamiento->setObjectName(QString::fromUtf8("textEditLogSaneamiento"));
        ...
        tabUnificacion->setObjectName(QString::fromUtf8("tabUnificacion"));
        ...
        comboBoxTiendas->setObjectName(QString::fromUtf8("comboBoxTiendas"));

        horizontalLayout->addWidget(comboBoxTiendas);

        pushButtonAnalizarIDs = new QPushButton(tabUnificacion);
        pushButtonAnalizarIDs->setObjectName(QString::fromUtf8("pushButtonAnalizarIDs"));
        ...
        tableWidgetIDs->setObjectName(QString::fromUtf8("tableWidgetIDs"));
        ...
        pushButtonGenerarSQL->setObjectName(QString::fromUtf8("pushButtonGenerarSQL"));

        horizontalLayout_2->addWidget(pushButtonGenerarSQL);

        pushButtonEjecutarUnificacion = new QPushButton(tabUnificacion);
        pushButtonEjecutarUnificacion->setObjectName(QString::fromUtf8("pushButtonEjecutarUnificacion"));
