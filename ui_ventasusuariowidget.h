...
public:
    ...
    void setupUi(QWidget *ventasUsuarioWidget)
    {
        if (ventasUsuarioWidget->objectName().isEmpty())
            ventasUsuarioWidget->setObjectName(QString::fromUtf8("ventasUsuarioWidget"));
...
"QCheckBox { font-weight: bold; color: #1c1e21; }"));
        ...
        frameStats->setObjectName(QString::fromUtf8("frameStats"));
        ...
        chkGlobal->setObjectName(QString::fromUtf8("chkGlobal"));
        QFont font2;
        ...
        tabWidge->setObjectName(QString::fromUtf8("tabWidge"));
        tabFechas = new QWidget();
        tabFechas->setObjectName(QString::fromUtf8("tabFechas"));
        horizontalLayout_Fechas = new QHBoxLayout(tabFechas);
        horizontalLayout_Fechas->setSpacing(20);
        horizontalLayout_Fechas->setObjectName(QString::fromUtf8("horizontalLayout_Fechas"));
        horizontalLayout_Fechas->setContentsMargins(15, 15, 15, 15);
        tableResumen = new QTableView(tabFechas);
        tableResumen->setObjectName(QString::fromUtf8("tableResumen"));
        ...
        fechasLayout->setObjectName(QString::fromUtf8("fechasLayout"));
        ...
        tabTickets->setObjectName(QString::fromUtf8("tabTickets"));
        verticalLayout_Tickets = new QVBoxLayout(tabTickets);
        verticalLayout_Tickets->setObjectName(QString::fromUtf8("verticalLayout_Tickets"));
        ...
        verticalLayout_Productos->setObjectName(QString::fromUtf8("verticalLayout_Productos"));
        verticalLayout_Productos->setContentsMargins(15, 15, 15, 15);
        tableProductos = new QTableView(tabProductos);
        tableProductos->setObjectName(QString::fromUtf8("tableProductos"));
