...
//Cabecera HTML
    QString html = "<!DOCTYPE html>\n"
                ...
                "<h5 class='text-center' style='text-align: center'> DESDE: "+fechaI+"  HASTA: "+fechaF+"</h5>\n"
                    "<table class='table'>\n";
    pagina << html;
//Cabecera
    pagina << "<thead>"
...
//Tabla HTML
    ...
    if (totalB > 0) {
        ...
        fichero.close();
        system("firefox "+QCoreApplication::applicationDirPath().toLocal8Bit()+"/documentos/ventas.html");
