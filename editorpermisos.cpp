...
void EditorPermisos::construirCheckboxes() {
  ...
  QMap<QString, QString> descripciones = {
      ...
      {"articulos.cambiar_codigo", "Cambiar código manual"},
      {"articulos.historial_precios", "Ver historial de precios"},
      {"articulos.trazabilidad", "Ver trazabilidad de lotes"},
      {"articulos.unificar", "Unificar artículos"},
      ...
      {"familias.unificar", "Unificar familias"},
      ...
      {"entradas.borrar", "Borrar líneas de entrada"},
      {"salidas", "Salidas de mercancía"},
      {"salidas.crear", "Crear salidas"},
      {"salidas.borrar", "Borrar líneas de salida"},
      ...
      {"tickets.imprimir", "Reimprimir tickets"},
      {"tickets.modificar", "Modificar datos de ticket"},
      {"tickets.facturar", "Generar factura desde ticket"},
      {"tickets.borrar", "Borrar tickets"},
      {"facturas", "Facturas"},
      {"albaranes", "Albaranes"},
      {"facturar", "Facturar albaranes"},
      {"gestionar_pedidos", "Gestión de pedidos"},
      {"pedidos.crear", "Crear pedido a proveedor"},
      {"pedidos.modificar", "Modificar líneas de pedido"},
      {"pedidos.borrar", "Borrar pedido / líneas"},
      {"pedidos.aceptar", "Aceptar pedido e importar a stock"},
      {"pedidos.imprimir", "Imprimir pedido"},
      {"cajas", "Acceso al módulo Cajas"},
      {"cajas.abrir", "Apertura de caja"},
      {"cajas.cerrar", "Cierre y arqueo de caja"},
      {"cajas.retirar", "Retirada de efectivo"},
      {"saneador_global", "Herramienta Saneador Global / Alineación"},
      ...
      {"notas.crear", "Crear notas/avisos"},
      {"notas.modificar", "Editar/resolver notas"},
      {"notas.borrar", "Borrar notas"},
      {"encargos", "Sistema de Encargos"},
      {"encargos.crear", "Crear nuevo encargo"},
      {"encargos.modificar", "Modificar estado del encargo"},
      {"encargos.borrar", "Eliminar encargo"},
      {"encargos.cobrar", "Cobrar encargo en TPV"},
      {"encargos.imprimir", "Imprimir comprobante de encargo"},
      {"visor_log", "Visor de logs"},
      {"visor_log.limpiar", "Limpiar registros de log"},
  ...
  QMap<QString, QString> nombresGrupos = {
      ...
      {"pedidos", "Pedidos (Acciones)"},
      {"cajas", "Cajas"},
      {"saneador_global", "Saneador Global"},
