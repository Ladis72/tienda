...
"}"));
        ...
        checkBoxTiendasConectadas->setObjectName(QString::fromUtf8("checkBoxTiendasConectadas"));
        ...
        horizontalLayoutKPI->setObjectName(QString::fromUtf8("horizontalLayoutKPI"));
        labelKpiGasto = new QLabel(groupBoxKPIs);
        labelKpiGasto->setObjectName(QString::fromUtf8("labelKpiGasto"));
        QFont font1;
        font1.setBold(true);
        ...
        comboBoxAgrupacion->addItem(QString());
        comboBoxAgrupacion->addItem(QString());
        comboBoxAgrupacion->setObjectName(QString::fromUtf8("comboBoxAgrupacion"));

        horizontalLayoutKPI->addWidget(comboBoxAgrupacion);

        labelTipoGrafico = new QLabel(groupBoxKPIs);
        labelTipoGrafico->setObjectName(QString::fromUtf8("labelTipoGrafico"));
        ...
        comboBoxTipoGrafico->addItem(QString());
        comboBoxTipoGrafico->setObjectName(QString::fromUtf8("comboBoxTipoGrafico"));

        horizontalLayoutKPI->addWidget(comboBoxTipoGrafico);

        horizontalSpacerKPI = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        widgetGraficoVentas->setObjectName(QString::fromUtf8("widgetGraficoVentas"));
        widgetGraficoVentas->setMinimumSize(QSize(0, 200));
        verticalLayoutGrafico = new QVBoxLayout(widgetGraficoVentas);
        verticalLayoutGrafico->setObjectName(QString::fromUtf8("verticalLayoutGrafico"));

        verticalLayout_Ventas->addWidget(widgetGraficoVentas);

        splitterVentas = new QSplitter(tab_4);
        splitterVentas->setObjectName(QString::fromUtf8("splitterVentas"));
        ...
        labelDesde_2->setObjectName(QString::fromUtf8("labelDesde_2"));

        gridLayout_3->addWidget(labelDesde_2, 0, 2, 1, 1);

        dateEditDesde_2 = new QDateEdit(Productos);
        dateEditDesde_2->setObjectName(QString::fromUtf8("dateEditDesde_2"));
        ...
        labelHasta_2->setObjectName(QString::fromUtf8("labelHasta_2"));

        gridLayout_3->addWidget(labelHasta_2, 0, 4, 1, 1);

        dateEditHasta_2 = new QDateEdit(Productos);
        dateEditHasta_2->setObjectName(QString::fromUtf8("dateEditHasta_2"));
        ...
        lineEditBuscarProducto->setObjectName(QString::fromUtf8("lineEditBuscarProducto"));
        ...
        btn_encargos_cliente->setObjectName(QString::fromUtf8("btn_encargos_cliente"));
