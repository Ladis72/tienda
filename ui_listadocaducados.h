...
public:
    ...
    void setupUi(QDialog *ListadoCaducados)
    {
        ...
        label_3 = new QLabel(ListadoCaducados);
        label_3->setObjectName(QString::fromUtf8("label_3"));

        horizontalLayout->addWidget(label_3);

        lineEditBuscar = new QLineEdit(ListadoCaducados);
        lineEditBuscar->setObjectName(QString::fromUtf8("lineEditBuscar"));
        lineEditBuscar->setClearButtonEnabled(true);

        horizontalLayout->addWidget(lineEditBuscar);
    ...
    void retranslateUi(QDialog *ListadoCaducados)
    {
        ...
        label_3->setText(QCoreApplication::translate("ListadoCaducados", "Buscar:", nullptr));
        lineEditBuscar->setPlaceholderText(QCoreApplication::translate("ListadoCaducados", "EAN o descripci\303\263n...", nullptr));
